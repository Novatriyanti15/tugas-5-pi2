...
class Model extends Connection
{
    ...
    //tabel matakuliah
    public function insert_matakuliah($id, $nama_matakuliah)
    {
        $sql = "INSERT INTO matakuliah (id, nama_matakuliah)
        VALUES ('$id', '$nama_matakuliah')";
        $this->conn->query($sql);
    }
    ...
    public function update_matakuliah($id, $nama_matakuliah)
    {
         $sql = "UPDATE matakuliah SET nama_matakuliah='$nama_matakuliah' WHERE id='$id'";
         $this->conn->query($sql);
    }
    ...
    //tabel koontrak_mk
    public function insert_kontrak_mk($id_matakuliah, $id_mahasiswa)
    {
        $sql = "INSERT INTO kontrak_mk (id_matakuliah, id_mahasiswa)
        VALUES ('$id_matakuliah', '$id_mahasiswa')";
        $this->conn->query($sql);
    }
    public function tampil_data_kontrak_mk()
    {
    ...
    public function edit_kontrak_mk($id)
    {
    ...
    public function update_kontrak_mk($id_matakuliah, $id_mahasiswa)
    {
         $sql = "UPDATE kontrak_mk SET id_matakuliah='$id_matakuliah',id_mahasiswa='$id_mahasiswa' WHERE id='$id'";
         $this->conn->query($sql);
    }
    public function delete_kontra_mk($id)
    {
